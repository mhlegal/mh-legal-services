    ...
    <section className="bg-zinc-100 py-24 md:py-32 border-t border-zinc-200">
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-4xl mx-auto bg-black text-white p-10 md:p-16 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-accent opacity-10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"></div>
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-8">
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4 w-full justify-center">
              <Button asChild size="lg" className="bg-accent text-black hover:bg-white hover:text-black rounded-none h-14 px-8 text-base font-semibold group transition-all">
                <Link href="/contact">
